...
if($valid_inscription == 1){
    ...
    if($mdp1 == $mdp2){
        ...
        if(count($rows)==0){
            ...
            register($nom,$prenom,$mail,$adresse,$cp,$ville,$mdp,$type_user,$con);
            //redirige vers index
  ...
  <head>
    ...
    <body class="h-vh-100 bg-dark fg-white">
      ...
      <form class="login-form bg-white p-6 mx-auto border bd-default win-shadow"
            ...
            <div class="form-group">
                <input type="text" name="rue" data-prepend="<span class='mif-envelop'>" placeholder="Saisir la rue" data-validate="required">
            </div>
